...
import mqtt.wire.control.packet.PublishRelease.VariableHeader
...
class PublishReleaseTests {
    ...
    fun reasonString() {
        ...
        val expected = ControlPacket.from(bytes) as PublishRelease
    ...
    fun variableHeaderPropertyUserProperty() {
        ...
        val requestRead = ControlPacket.from(request.copy()) as PublishRelease
