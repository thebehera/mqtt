...
data class PublishMessage(
    ...
    data class VariableHeader(val topicName: Name,
        ...
        init {
            if (properties.topicAlias == 0.toUShort()) {
                throw ProtocolError("Topic Alias not permitted to be set to 0:" +
        ...
        data class Properties(
                 ...
                 */
                val messageExpiryInterval: UInt? = null,
                /**
                 ...
                 * is not significant.
                 */
                val subscriptionIdentifier: Set<UInt> = emptySet(),
                /**
            ...
            companion object {
                fun from(keyValuePairs: Collection<Property>?): Properties {
                    ...
                    var topicAlias: UShort? = null
                    var responseTopic: MqttUtf8String? = null
                    var coorelationData: ByteArrayWrapper? = null
                    var userProperty: Collection<Pair<MqttUtf8String, MqttUtf8String>> = mutableSetOf()
                    val subscriptionIdentifier = LinkedHashSet<UInt>()
                    ...
                    keyValuePairs?.forEach {
                        when (it) {
                            ...
                            is TopicAlias -> {
                                if (topicAlias != null) {
                                    throw ProtocolError("Topic Alias found twice see:" +
                                            "https://docs.oasis-open.org/mqtt/mqtt/v5.0/cos02/mqtt-v5.0-cos02.html#_Toc1477413")
                                }
                            ...
                            is SubscriptionIdentifier -> {
                                if (it.value == 0.toUInt()) {
                                    throw ProtocolError("Subscription Identifier not permitted to be set to 0:" +
